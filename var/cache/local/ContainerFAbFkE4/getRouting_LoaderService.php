...
class getRouting_LoaderService extends App_KernelLocalDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $e = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('local');

        $b->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($d, 'local'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($d, 'local'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($d, 'local'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($d, 'local'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($d, 'local'));
